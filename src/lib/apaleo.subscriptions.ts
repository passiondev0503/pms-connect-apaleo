import { IConnected_SubscriptionBody, IConnected_SubscriptionDefinition, IConnected_WebHookDefinition, IConnected_WebHook_CreateResponse } from '@cord-travel/pms-connect/dist/models'
...
export interface IApaleo_ARISubscription_Body extends IApaleo_ARISubscription_Base {

}

export function toChannectedSubscription(s: IApaleo_ARISubscription): IConnected_SubscriptionDefinition {
...
export function toApaleoARISubscriptionBody(s: IConnected_SubscriptionBody): IApaleo_ARISubscription_Body {
    return {
